...
- Demo mode uses simulated AI (rule-based)
- No real-time collaboration features
- Limited to MCQ questions (can extend to other types)
- No file upload support for questions

## 👥 Team & Credits

Built for **Hackathon HC-303** by a passionate team focused on revolutionizing education through technology.
...
1. **Problem-Solution Fit** - Clear problem statement and solution
2. **AI Implementation** - Explain adaptive difficulty and feedback engines
3. **Gamification** - Show points, badges, levels, leaderboards
4. **Analytics** - Demonstrate teacher dashboard with charts
5. **User Experience** - Walk through student and teacher flows
6. **Scalability** - Mention future enhancements

### Demo Script:
1. Start with problem statement (30s)
2. Show student flow: Login → Take Quiz → See Feedback (2min)
3. Show teacher dashboard with analytics (1min)
4. Explain AI logic (1min)
5. Show leaderboard and gamification (30s)
6. Future scope (30s)

**Total: ~5-6 minutes** (perfect for hackathon presentations!)
